...
if (UNIX)
    message(STATUS "To install ffmpeg devel:")
    message(STATUS "    sudo apt install libavcodec-dev libavdevice-dev libavfilter-dev")
    message(STATUS "    sudo apt install libavformat-dev libavutil-dev libpostproc-dev")
    message(STATUS "    sudo apt install libswresample-dev libswscale-dev")
endif()
...
if (WIN32)
    macro(ffmpeg_copy_dll_after_build target dll_name)
        ...
        tool_copy_file_after_build(${aux_project_name} ${dll_name})
