...
namespace FFmpegWrapper {
    ...
    public:
        ...
        ///
        void initFromStream(AVStream*stream, const EventCore::Callback<void(AVPacket *)> &OnData);
        ...
        /// \param OnData callback. Called when it has any data available
        ///
        void initFromCodecContext(const AVCodecContext *codecCTX, const EventCore::Callback<void(AVPacket *)> &OnData);
